...
export default function AdminPage() {
  ...
  const [deployedAddress, setDeployedAddress] = useState<string | null>(
    () => localStorage.getItem('VEILVAUL_CONTRACT_ADDRESS'),
  );
  ...
  const handleDeploy = useCallback(async () => {
    ...
    try {
      ...
      const deployTxData = await createUnprovenDeployTx(session.providers as any, {
        ...
        privateStateId: 'VeilVaultAdminState',
        initialPrivateState: {},
      ...
      // Wait for indexer to pick up the contract
      await waitForContractDeployment(session.providers.publicDataProvider, contractAddress);

      setDeployedAddress(contractAddress);
      localStorage.setItem('VEILVAUL_CONTRACT_ADDRESS', contractAddress);
      setStatus('deployed');
    } catch (e: any) {
      setStatus('error');
      ...
      <div className="page">
        <div className="container" style={{ maxWidth: 640, textAlign: 'center', paddingTop: '4rem' }}>
          ...
          <p style={{ marginBottom: '1.5rem' }}>
            Connect your 1AM wallet with admin privileges to deploy and manage the VeilVault contract.
          </p>
          <WalletButton />
        </div>
      </div>
      ...
      <div className="container" style={{ maxWidth: 680 }}>
        <div style={{ marginBottom: '2rem', animation: 'fadeInDown 0.5s ease both' }}>
          ...
          <p>
            ...
            Admin operations require the private admin key for authentication.
          </p>
        </div>
          ...
          <div className="card animate-fade-up" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="field">
              ...
              <p className="text-muted mt-1" style={{ fontSize: '0.8125rem' }}>
                This stays in the ZK circuit — never goes on-chain.
              </p>
            </div>
