    ...
    <div className="page">
      <div className="container" style={{ maxWidth: 760 }}>
        <div style={{ marginBottom: '2rem', animation: 'fadeInDown 0.5s ease both' }}>
          ...
          <p>
            The tally is fully public and verifiable on-chain. Individual ballots remain private.
          </p>
        </div>
        ...
        {!isConnected ? (
          <div className="card text-center" style={{ padding: '3rem 2rem' }}>
            ...
            <h3 style={{ marginBottom: '0.75rem' }}>Connect to View Results</h3>
            ...
            <div className="card mb-6 animate-fade-up">
              <div className="field">
                ...
                <input
                  ...
                  type="text"
                  className="input"
                  placeholder="Paste the VeilVault contract address"
              ...
              <div className="animate-fade-up">
                ...
                <div className="stats-grid mb-6">
                  ...
                  <div className="card stat-card">
                    ...
                    <div className="stat-card__label" style={{ fontSize: '0.7rem' }}>Deadline</div>
                  </div>
                </div>
                  ...
                  <div className="privacy-shield">
                    ...
                    <div>
                      ...
                      <p className="privacy-shield__body">
                        These numbers are 100% verifiable on-chain. However, it is
                        cryptographically impossible to determine which voter cast which ballot.
                        The ZK proof ensures the tally is correct without revealing individual choices.
                      </p>
                    </div>
                  </div>
                </div>
